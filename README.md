...
# v1.1.2 Change log:
- **Chat Messages Have Been Reworked:** Chat messages are now a lot better, with a lot more than just one when the round ends

- **Best time per map tracking system**
- **GRACE Stats**
- **Custom Chat Messages**
- **Save ALL Match Results To A Text File**
